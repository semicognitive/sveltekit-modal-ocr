...
<main class="flex flex-col space-y-2">
    <h1 class="text-3xl font-bold underline">Receipt OCR</h1>
    ...
    <form method="POST" action="/api/ocr" use:enhance={api_ocr} on:change={() => ((error = undefined), (output = undefined))} class="flex flex-col space-y-2 md:min-w-[28rem] lg:min-w-[32rem] xl:min-w-[36rem] max-w-6xl">
